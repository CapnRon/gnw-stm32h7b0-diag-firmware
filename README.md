...
The sections below are from the upstream retro-go project. They describe
features not used by this diagnostic firmware, such as the emulator
collection and game controls.
